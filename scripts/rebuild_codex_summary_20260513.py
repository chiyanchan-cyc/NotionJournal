...
NOTE_TITLE = "20260513 Codex Summary"
NOTE_DATE = "2026-05-13"
NOTEBOOK = "Me"
TAB_DOMAIN = "Dev"
PRIMARY_DOMAIN = "me.dev"
DELETE_TITLES = ["(20260513) Codex Summary", "20260513 Codex Summary"]

SESSION_ROOT = Path("/Users/mac/.codex/sessions/2026/05/13")
LOCAL_TZ = timezone(timedelta(hours=8))
DAY_START_LOCAL = datetime(2026, 5, 13, 0, 0, 0, tzinfo=LOCAL_TZ)
DAY_END_LOCAL = datetime(2026, 5, 14, 0, 0, 0, tzinfo=LOCAL_TZ)
...
def main() -> None:
    ...
    txt_path = SOURCE_ROOT / "20260513-codex-source.txt"
    json_path = SOURCE_ROOT / "20260513-codex-source.json"
    pdf_path = SOURCE_ROOT / "20260513-codex-source.pdf"
    ...
    source_doc = {
        ...
        "source": "No local programming work was captured in Codex for 2026-05-13; the only session was automation research, so no programming blocks or timeslots were created",
    ...
    existing_slots = cur.execute(
        ...
        """,
        ("%/Users/mac/.codex/sessions/2026/05/13/%",),
    ).fetchall()
    cur.execute(
        """
        ...
        WHERE owner_scope = 'ME' AND deleted = 0 AND title LIKE 'Codex:%' AND notes LIKE ?
        """,
        (DAY_START_MS, "%/Users/mac/.codex/sessions/2026/05/13/%"),
    )
