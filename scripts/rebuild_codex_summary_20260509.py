...
NOTE_TITLE = "20260509 Codex Summary"
NOTE_DATE = "2026-05-09"
NOTEBOOK = "Me"
TAB_DOMAIN = "Dev"
PRIMARY_DOMAIN = "me.dev"
DELETE_TITLES = ["(20260509) Codex Summary", "20260509 Codex Summary"]

SESSION_ROOT = Path("/Users/mac/.codex/sessions/2026/05/09")
LOCAL_TZ = timezone(timedelta(hours=8))
DAY_START_LOCAL = datetime(2026, 5, 9, 0, 0, 0, tzinfo=LOCAL_TZ)
DAY_END_LOCAL = datetime(2026, 5, 10, 0, 0, 0, tzinfo=LOCAL_TZ)
...
def main() -> None:
    ...
    txt_path = SOURCE_ROOT / "20260509-codex-source.txt"
    json_path = SOURCE_ROOT / "20260509-codex-source.json"
    pdf_path = SOURCE_ROOT / "20260509-codex-source.pdf"
    ...
    source_doc = {
        ...
        "source": "No local Codex session files were captured for 2026-05-09",
    ...
    existing_slots = cur.execute(
        ...
        """,
        ("%/Users/mac/.codex/sessions/2026/05/09/%",),
    ).fetchall()
    cur.execute(
        """
        ...
        WHERE owner_scope = 'ME' AND deleted = 0 AND title LIKE 'Codex:%' AND notes LIKE ?
        """,
        (DAY_START_MS, "%/Users/mac/.codex/sessions/2026/05/09/%"),
    )
